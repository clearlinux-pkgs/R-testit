...
Version  : 0.10
Release  : 58
URL      : https://cran.r-project.org/src/contrib/testit_0.10.tar.gz
Source0  : https://cran.r-project.org/src/contrib/testit_0.10.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1569990778
